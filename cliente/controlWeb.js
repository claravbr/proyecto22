function ControlWeb(){
    ...
    this.mostrarAgregarUsuario=function(){
		...
		$("#btnAU").on("click",function(e){
			if ($('#usr').val() === '' || $('#usr').val().length>6) {
                ...
                //mostrar gif mientras carga
                //no se pone aqui el mostrarHome() porque la linea anterior se ejecuta concurrentemente
			}
		})
	}
    ...
    this.mostrarListaDePartidas = function(){
        ...
        // y permitir unirse con un click a la partida seleccionada
    }
}